...
const AddFlashDeal = () => {
  ...
  const getAllFlashDeals = () => {
    axios
      ...
      .then(response => {
        // console.log("flashDeal data",response.data.flashDeals);
        const allFlashDeals = response.data.flashDeals;
        getFlashDeals(allFlashDeals);
        // setLoading(false);
        //   menu = allFlashDeals.map((flashDeal)=>{
        //       console.log("sdlksl",flashDeal)
        //       return(<MenuItem value={flashDeal._id}>{flashDeal.name}</MenuItem>)
        //       });
      })
      .catch(error => {
        console.log(error);
        ...
        <Container maxWidth="md">
          <Formik
            ...
            onSubmit={values => {
              ...
              axios
                .post(CONSTANTS.BASE_URL + 'api/flash', data)
                .then(response => {
