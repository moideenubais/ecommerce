...
const Results = ({
  ...
  const handleDeliveryConfirm = (order, index) => {
    ...
    axios
      .put(CONSTANTS.BASE_URL + 'api/order/updateDeliveryStatus/' + order._id,{delivery_status:'delivered'})
      .then(response => {
  ...
  const handlePaymentConfirm = (order, index) => {
    axios
      .put(CONSTANTS.BASE_URL + 'api/order/updatePaymentStatus/' + order._id,{payment_status:'paid'})
      .then(response => {
        setconfirmOpen(false);
                ...
                >
                  ...
                  <TableCell align="right">
                    <IconButton
                      ...
                      onClick={() => {
                        navigate('/app/orders/assignedDelivery/' + order._id, {
                          replace: false
                        });
                      }}
                    >
                  ...
                  <TableCell>
                    {order.payment_status === 'paid' && order.delivery_status !== 'delivered' && <Button
                      color="primary"
                      variant="contained"
                    ...
                    {confirmOpen ? (
                      <>
                        ...
                        />}
                        {order.openConfirmStatus && <AlertDialog
